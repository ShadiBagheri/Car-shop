...
const Categories = () => {
    return(
        <div className="flex items-center justify-between w-[550px] h-[110px] mb-10 mx-auto p-5 bg-[#fff] shadow-md">
            <Link href="/categories/sedan">
                <div className="flex flex-col items-center w-[100px] p-3 bg-amber-500  hover:bg-amber-600 shadow">
